Shader "Custom/Chapter32_Ocean"
{
    ...
    SubShader
    {
        ...
        // �������������� _CameraDepthTexture��
        Tags    // Rendering Order - Queue tag ֻ��д������
        {
            "Queue" = "Transparent"
        ...
        Pass
        {
            ...
            float3x3 _tbn(float2 worldPos, float d)
            {
                ...
                // ʹ��worldPos������ƽ���ϵ�tangent��binormal
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 finalColor = baseColor + reflectedColor + edgeFoamColor + 1-sparkleColor + specularColor + sssColor + foamColor;
